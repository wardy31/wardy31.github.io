  ...
  <v-app>
    <v-main class="bg">
      ...
      <h2 class="primary--text font-weight-bold mt-12 mb-1">Health Declaration Records</h2>
      <h5> List of student, personnels or visitors <br> Health Declaration Form Records</h5>
      ...
      <div class="adj mt-16 pt-6 d-flex">
        ...
        <v-simple-table class="rounded-lg elevation-6">
          ...
          <tbody>
              ...
              <td>
                  <v-tooltip bottom>
                    <template v-slot:activator="{ on, attrs }">
                      <v-btn color="primary" dark v-bind="attrs" v-on="on" icon><v-icon>description</v-icon></v-btn>
                    </template>
            ...
            <v-pagination v-model="page" :length="4" class="float-left mt-4" @input="pageSwitch"></v-pagination>
            {{page_number}}
      </div>
    </v-main>
  </v-app>
